...
export default function FormDialogUpdate({open, setOpen, userId}) {
  ...
  useEffect(() => {
    userId && SDK.SmsTextType.getById(userId)
    .then((res) => {
      console.log("RES: ", res);
  ...
  const onSubmit = (values) => {
    ...
    if(values?.text == '' || values?.text == 'undefined' || values?.text == null){
      setErrorVM("Enter a Valid SMS Text.");
      return;
    } 
    ...
    const obj = {
      ...
      SDK.SmsTextType.update(userId, obj)
    .then((res) => {
      console.log("RES: ", res);
  ...
  return (
    <div>
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle>Update Sms Text</DialogTitle>
        <DialogContent>
